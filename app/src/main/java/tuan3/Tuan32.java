...
public class Tuan32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ls.add(new T32Contact("Tran van b","16",R.drawable.ic_launcher_background));
        ls.add(new T32Contact("Vu van c","17",R.drawable.ic_launcher_background));
        ls.add(new T32Contact("Nguyen thi d","22",R.drawable.ic_launcher_background));
        ls.add(new T32Contact("Nguyen van y","32",R.drawable.ic_launcher_background));
        ls.add(new T32Contact("Nguyen van x","11",R.drawable.ic_launcher_background));
        //tao adapter
